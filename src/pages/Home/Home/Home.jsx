...
import bgImage from '../../../assets/hand-2.jpg'
        ...
        <div>
            ...
            <div className='my-44 my-container font-poppins'>
                ...
                <div className='grid lg:grid-cols-2 grid-cols-1 gap-10 lg:gap-16'>
                    <div>
                        <img src="https://n.foxdsgn.com/zuko/wp-content/uploads/2021/04/Frame-153-1-1024x579.jpg" alt="" srcset="" />
                    </div>
                ...
                <div className='grid lg:grid-cols-2 grid-cols-1 gap-10 lg:gap-16 lg:my-80 my-20'>
                    ...
                    <div className=' relative lg:top-44 top-10 lg:order-2 order-1'>
                        <img src="https://n.foxdsgn.com/zuko/wp-content/uploads/2021/04/Frame-125-1-1024x579.jpg" alt="" srcset="" />
                    </div>
                </div>
                <div className='grid lg:grid-cols-2 grid-cols-1 gap-10 lg:gap-16'>
                    <div>
                        <img src="https://n.foxdsgn.com/zuko/wp-content/uploads/2021/04/Frame-148-1-1024x579.jpg" alt="" srcset="" />
                    </div>
                    <div className=' relative lg:top-52 top-10 space-y-4'>
            ...
            <div className='lg:py-36'>
                ...
                >
                    <div className="absolute inset-0 bg-gradient-to-r from-[#080808] to-[rgba(21, 21, 21, 0)] absolute left-0 top-0" >
                        <div className="absolute inset-0  my-32 text-white">
            ...
            <div className='my-container lg:my-0 py-14'>
