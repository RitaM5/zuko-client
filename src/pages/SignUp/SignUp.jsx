                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="card-body w-full">
                            ...
                            <div className="form-control font-poppins relative">
                                <input type={show ? "text" : "password"}  {...register("password", {
                                    ...
                                    maxLength: 15,
                                    pattern: /(?=.*[A-Z])(?=.*[!@#$&*])(?=.*[0-9])(?=.*[a-z])/
                                })} placeholder="Your Password" className="input input-bordered rounded-full w-full" />
                                <p className=' absolute right-0 mt-4 mr-4 text-lg' onClick={() => setShow(!show)}>
                                    <FaRegEye />
                                </p>
                            ...
                            <div className="form-control font-poppins">
                                ...
                                })} placeholder="Confirm Password" className="input input-bordered rounded-full w-full" />
                                <p className=' absolute right-0 mt-4 mr-12 text-lg' onClick={() => setShow(!show)}>
                                    <FaRegEye />
                                </p>
                                {errors.password?.type === 'required' && <p className="text-red-600">Password is required</p>}
                            ...
                            <div className="form-control mt-3 font-poppins">
                                <input className="py-3 bg-teal-800 text-white rounded-full w-full" type="submit" value="Sign Up" />
                            </div>
