      ...
      >
        <div className="flex items-center gap-2.5 font-medium border-b py-3 border-slate-300  mx-3">
          <img
            ...
            alt=""
          />
          <span className="text-xl whitespace-pre">Zuko</span>
        </div>
        ...
        <div className="flex flex-col  h-full">
          <ul className="whitespace-pre px-2.5 text-[0.9rem] py-5 flex flex-col gap-1 text-lg space-y-5 mt-2 font-medium overflow-x-hidden scrollbar-thin scrollbar-track-white scrollbar-thumb-slate-100   md:h-[68%] h-[70%]">
            <li>
              <NavLink to={"/dashboard/userhome"} className=" inline-flex items-center gap-2">
            ...
            <li>
              <NavLink to={"#"} className="items-center inline-flex gap-2 mt-12">
          ...
          {open && (
            <div className="flex-1 text-[18px] z-50  max-h-48 my-auto  whitespace-pre   w-full  font-medium  ">
              <div className="flex border-y border-slate-300 p-4 items-center justify-between">
                <div>
                  <p>Spark</p>
                  <small>No-cost $0/month</small>
                </div>
                <p className="text-teal-500 py-1.5 px-3 text-xs bg-teal-200 rounded-xl">
                  Upgrade
                </p>
              </div>
            </div>
